<?php
define('TITLE','Top Downloads - All Categories');
require('includes/header.php');

$sql2 = mysql_query("select `id` from `softwares`");
...
<script type="text/javascript">
  $(document).ready(function(){
	  ...
	  function loadData(page){
		  ...
		  ({
			  type: "POST",
			  url: "<?php echo URL; ?>load_data_all.php",
			  data: "key=topdownloads&page="+page,
...
<div class="fixbox">
<div class="breadcrumb">You are here :  <a href="<?php echo URL; ?>home/">Home</a> / <a href="javascript:void(0);">Top Downloads</a></div>
</div>

<div class="reviewbox1">
<div class="reviews">
<h1>Top Downloads - All Categories</h1>
</div>
<div class="box2">
<!-- Start-->
