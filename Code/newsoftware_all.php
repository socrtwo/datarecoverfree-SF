<?php
define('TITLE','New Software - All Categories');
  ...
  $(document).ready(function(){
	  ...
	  function loadData(page){
		  ...
		  ({
			  ...
			  data: "key=newsoftware&page="+page,
...
<div class="fixbox">
<div class="breadcrumb">You are here :  <a href="<?php echo URL; ?>home/">Home</a> / <a href="javascript:void(0);">New Softwares</a></div>
</div>

<div class="reviewbox1">
<div class="reviews">
<h1>New Softwares - All Categories</h1>
</div>
<div class="box2">
<!-- Start-->
<ul id="softwaretabs" class="shadetabs">
<li><a href="javascript:void(0);" rel="software1" class="selected">New Software</a></li>
</ul>
