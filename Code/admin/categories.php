<?php define('TITLE','Categories Page'); require('includes/header.php'); ?>
<?php
	$del_id = isset($_REQUEST['del_id'])?mysql_real_escape_string($_REQUEST['del_id']):'';
	
	if($del_id){
		$del_sql = mysql_query("delete from categories where id='$del_id'");
		if($del_sql == 'true'){
			header('Location: categories.php?info=Category Deleted Successfully');
		}else
			header('Location: categories.php?info=Error in Deleting. Please try again later');
	}
?>
...
<?php	/*
	...
	*/
	...
	/* Get data. */
	$sql = "SELECT * FROM $tbl_name order by parentid desc LIMIT $start, $limit";
...
<div id="admintablewrapper">
  <table width="100%" bgcolor="#FFFFFF" cellpadding="3" cellspacing="3" border="0" style="font:'trebuchet MS'; font-size:12px; margin:0px;">
    <tr style=" color:#FFFFFF; background-color:#40679e; text-align:center; width:100%;">
      ...
      <td style="width:25%;">Parent Id</td>
	...
	<?php
        ...
        <td class="actions"><a href="editcategory.php?id=<?php echo $row['id']; ?>">Edit</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="viewcategory.php?id=<?php echo $row['id']; ?>">View Details</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" onClick='var answer = confirm("Are you sure want to delete this?"); if (answer){ window.location = "categories.php?del_id=<?php echo $row['id']; ?>"; }'>Delete</a></td>
	    </tr>
