Data Recover Free — iOS / iPadOS
============================

How to install (recommended)
----------------------------
Data Recover Free installs from Safari as a Progressive Web App.

1. Open Safari on your iPhone/iPad.
2. Visit:  https://socrtwo.github.io/datarecoverfree-SF/
...
Privacy
-------
Any file you open never leaves your device; all processing happens locally
in Safari.
