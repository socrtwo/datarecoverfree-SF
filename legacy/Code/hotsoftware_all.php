<?php
define('TITLE','Hot Software - All Categories');
  ...
  $(document).ready(function(){
	  ...
	  function loadData(page){
		  ...
		  ({
			  ...
			  data: "key=hotsoftware&page="+page,
...
<div class="fixbox">
<div class="breadcrumb">You are here :  <a href="<?php echo URL; ?>home/">Home</a> / <a href="javascript:void(0);">Hot Softwares</a></div>
</div>

<div class="reviewbox1">
<div class="reviews">
<h1>Hot Softwares - All Categories</h1>
</div>
<div class="box2">
<!-- Start-->
