  ...
  $(document).ready(function(){
	  ...
	  function loadData(page){
		  ...
		  ({
			  ...
			  data: "key=topdownloads&catid="+<?php echo $res2['id']; ?>+"&page="+page,
...
<div class="fixbox">
<div class="breadcrumb">You are here :  <a href="<?php echo URL; ?>home/">Home</a> / <a href="<?php echo URL.'sub-category/'.strtolower(str_replace(' ','-',$res2['name'])).'/'.$res2['id'].'/'; ?>"><?php echo $res2['name']; ?></a> / <a href="javascript:void(0);">Top Downloads</a></div>
</div>

<div class="reviewbox1">
<div class="reviews">
<h1><?php echo $res2['name']; ?> - Top Downloads</h1>
</div>
<div class="box2">
<!-- Start-->
<ul id="softwaretabs" class="shadetabs">
<li><a href="javascript:void(0);" rel="software1" class="selected">Top Downloads</a></li>
</ul>
